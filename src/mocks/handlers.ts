...
export const handlers = [
  ...
  rest.put(`${API_PATHS}/product`, (req, res, ctx) => {
    return res(ctx.status(200));
  }),
  rest.delete(`${API_PATHS}/product/:id`, (req, res, ctx) => {
    return res(ctx.status(200));
  }),
  rest.get(`${API_PATHS}/product/available`, (req, res, ctx) => {
    return res(
      ctx.status(200),
      ctx.delay(),
  ...
  rest.get(`${API_PATHS}/profile/cart`, (req, res, ctx) => {
    return res(ctx.status(200), ctx.delay(), ctx.json<CartItem[]>(cart));
  }),
  rest.put(`${API_PATHS}/profile/cart`, (req, res, ctx) => {
    return res(ctx.status(200));
  }),
